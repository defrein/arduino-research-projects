...
void home12() {
  myservo.write(s1, hom[0]); myservo.write(s13, hom[0]); myservo.write(s10, hom[0]);
  myservo.write(s2, hom[0]+30); myservo.write(s14, hom[0]+30); myservo.write(s11, hom[0]+20);
  myservo.write(s3, hom[0]+20); myservo.write(s15, hom[0]+20); myservo.write(s12, hom[0]+40);
  myservo.write(s4, hom[0]); myservo.write(s16, hom[0]); myservo.write(s7, hom[0]);
  myservo.write(s5, hom[0]+20); myservo.write(s17, hom[0]+20); myservo.write(s8, hom[0]+30);
  myservo.write(s6, hom[0]+40); myservo.write(s18, hom[0]+40); myservo.write(s9, hom[0]+20);
}
