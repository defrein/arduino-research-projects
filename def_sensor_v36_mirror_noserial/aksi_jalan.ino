...
void geser_kanan_retak_bawah() {
 ...
 myservo.write(s6, hom[0]); myservo.write(s18, hom[0]); myservo.write(s9, hom[0]);
  ...
  for (int n2 = 190, n14 = 190, n11 = 110; !(n2 == 130 && n14 == 130 && n11 >= 170); n2 -= 20, n14 -= 20, n11 += 20) {
   ...
   for (int n3 = 120, n15 = 120, n12 = 120, n5 = 150, n17 = 150, n8 = 150; !(n3 == 165 && n15 == 165 && n12 == 165 && n5 <= 90 && n17 <= 190 && n8 >= 210); 
  ...
  for (int n5 = 110, n17 = 110, n8 = 190; !(n5 == 170 && n17 == 170 && n8 <= 130); n5 += 20, n17 += 20, n8 -= 20) {
   ...
   delay(20);  // Delay untuk memberikan waktu servos bergerak
    ...
    for (int n6 = 120, n18 = 120, n9 = 120, n2 = 150, n14 = 150, n11 = 150; !(n6 == 165 && n18 == 165 && n9 == 165, n2 == 210 && n14 == 210 && n11  <= 90); 
...
void geser_kanan_tangga_tengah1() {
 myservo.write(s2, hom[0] + 20); myservo.write(s14, hom[0] + 20); myservo.write(s8, hom[0] + 20);
 myservo.write(s3, hom[0]); myservo.write(s15, hom[0]); myservo.write(s12, hom[0]+30);
 myservo.write(s6, hom[0]+30); myservo.write(s18, hom[0]+30); myservo.write(s9, hom[0]);

  for (int n2 = 170, n14 = 170, n11 = 150; !(n2 == 215 && n14 == 215 && n11  <= 105); n2 += 15, n14 += 15, n11 -= 15) {
    myservo.write(s2, n2);    // Menggerakkan servo 2   
    myservo.write(s14, n14);  // Menggerakkan servo 14
    myservo.write(s11, n11);  // Menggerakkan servo 11
       delay(20);  // Delay untuk memberikan waktu servos bergerak
  ...
  for (int n3 = 150, n15 = 150, n12 = 180; !(n3 == 105 && n15 == 105 && n12 == 135); n3 -= 15, n15 -= 15, n12 -= 15) {
    myservo.write(s3, n3);    // Menggerakkan servo 1
     myservo.write(s15, n15);  // Menggerakkan servo 13
       myservo.write(s12, n12);  // Menggerakkan servo 10
        delay(20);  // Delay untuk memberikan
  ...
  for (int n2 = 200, n14 = 200, n11 = 120; !(n2 == 155 && n14 == 155 && n11 >= 165); n2 -= 15, n14 -= 15, n11 += 15) {
    myservo.write(s2, n2);    // Menggerakkan servo 2
        myservo.write(s14, n14);  // Menggerakkan servo 14
      myservo.write(s11, n11);  // Menggerakkan servo 11
       delay(20);  // Delay untuk memberikan waktu servos bergerak
   ...
   for (int n3 = 120, n15 = 120, n12 = 150, n5 = 150, n17 = 150, n8 = 170; !(n3 == 165 && n15 == 165 && n12 == 195 && n5 <= 105 && n17 <= 105 && n8 >= 215); 
    n3 += 15, n15 += 15, n12 += 15, n5 -= 15, n17 -= 15, n8 += 15 ) {
    myservo.write(s3, n3);
   myservo.write(s15, n15);
    myservo.write(s12, n12);
   myservo.write(s5, n5);
    myservo.write(s17, n17);
     myservo.write(s9, hom[0]+20);
     
    myservo.write(s8, n8);
   delay(20);  // Delay untuk memberikan waktu servos bergerak
    }

    for (int n6 = 180, n18 = 180, n9 = 150; !(n6 == 129 && n18 == 129 && n9 == 105); n6 -= 17, n18 -= 17, n9 -= 15) {
    myservo.write(s6, n6);    // Menggerakkan servo 2
    myservo.write(s18, n18);  // Menggerakkan servo 14
    myservo.write(s9, n9);  // Menggerakkan servo 11
   delay(20);  // Delay untuk memberikan waktu servos bergerak
  ...
  for (int n5 = 120, n17 = 120, n8 = 200; !(n5 == 165 && n17 == 165 && n8 <= 155); n5 += 15, n17 += 15, n8 -= 15) {
    myservo.write(s5, n5);    // Menggerakkan servo 2
    myservo.write(s17, n17);  // Menggerakkan servo 14
    myservo.write(s8, n8);  // Menggerakkan servo 11
   delay(20);  // Delay untuk memberikan waktu servos bergerak
    ...
    for (int n6 = 146, n18 = 146, n9 = 120, n2 = 170, n14 = 170, n11 = 150; !(n6 == 197 && n18 == 197 && n9 == 165, n2 == 215 && n14 == 215 && n11  <= 105); 
    n6 += 17, n18 += 17, n9 += 15, n2 += 15, n14 += 15, n11 -= 15) {
    myservo.write(s6, n6);    // Menggerakkan servo 2
  myservo.write(s18, n18);  // Menggerakkan servo 14
   myservo.write(s9, n9);  // Menggerakkan servo 11
      myservo.write(s2, n2);    // Menggerakkan servo 2
 ...
 void geser_kanan_tangga_tengah2() {

 myservo.write(s3, hom[0]); myservo.write(s15, hom[0]); myservo.write(s12, hom[0]+20);
 myservo.write(s6, hom[0]+30); myservo.write(s18, hom[0]+30); myservo.write(s9, hom[0]);
  ...
  for (int n2 = 180, n14 = 180, n11 = 120; !(n2 == 135 && n14 == 135 && n11 >= 165); n2 -= 15, n14 -= 15, n11 += 15) {
   ...
   for (int n3 = 120, n15 = 120, n12 = 150, n5 = 150, n17 = 150, n8 = 150; !(n3 == 165 && n15 == 165 && n12 == 195 && n5 <= 105 && n17 <= 105 && n8 >= 195); 
    n3 += 15, n15 += 15, n12 += 15, n5 -= 15, n17 -= 15, n8 += 15 ) {
    myservo.write(s3, n3);
    myservo.write(s15, n15);
    myservo.write(s12, n12);
    ...
    for (int n6 = 180, n18 = 180, n9 = 150; !(n6 == 135 && n18 == 135 && n9 == 105); n6 -= 15, n18 -= 15, n9 -= 15) {
    myservo.write(s6, n6);    // Menggerakkan servo 2
    myservo.write(s18, n18);  // Menggerakkan servo 14
    myservo.write(s9, n9);  // Menggerakkan servo 11
       delay(20);  // Delay untuk memberikan waktu servos bergerak
  ...
  for (int n5 = 120, n17 = 120, n8 = 180; !(n5 == 165 && n17 == 165 && n8 <= 135); n5 += 15, n17 += 15, n8 -= 15) {
   ...
   delay(20);  // Delay untuk memberikan waktu servos bergerak
    ...
    for (int n6 = 150, n18 = 150, n9 = 120, n2 = 150, n14 = 150, n11 = 150; !(n6 == 195 && n18 == 195 && n9 == 165, n2 == 195 && n14 == 195 && n11  <= 105); n6 += 15, n18 += 15, n9 += 15, n2 += 15, n14 += 15, n11 -= 15) {
    myservo.write(s6, n6);    // Menggerakkan servo 2
  myservo.write(s18, n18);  // Menggerakkan servo 14
    myservo.write(s9, n9);  // Menggerakkan servo 11
         myservo.write(s2, n2);    // Menggerakkan servo 2
 ...
 myservo.write(s6, hom[0]); myservo.write(s18, hom[0]); myservo.write(s9, hom[0]);
  ...
  for (int n3 = 180, n15 = 180, n12 = 180; !(n3 == 135 && n15 == 135 && n12 == 135 );
       n3 -= 15, n15 -= 15, n12 -= 15) {
    myservo.write(s3, n3);
     myservo.write(s15, n15);
    myservo.write(s12, n12);
 ...
 void geser_kanan_sempit_mirror() {
 ...
 myservo.write(s6, hom[0]); myservo.write(s18, hom[0]); myservo.write(s9, hom[0]);
  ...
  for (int n3 = 150, n15 = 150, n12 = 150; !(n3 == 135 && n15 == 135 && n12 == 135); n3 -= 5, n15 -= 5, n12 -= 5) {
    myservo.write(s3, n3);    // Menggerakkan servo 1
     myservo.write(s15, n15);  // Menggerakkan servo 13
    myservo.write(s12, n12);  // Menggerakkan servo 10
    delay(20);  // Delay untuk memberikan
  ...
  for (int n2 = 180, n14 = 180, n11 = 120; !(n2 == 135 && n14 == 135 && n11 >= 165); n2 -= 15, n14 -= 15, n11 += 15) {
   ...
   for (int n3 = 140, n15 = 140, n12 = 140, n5 = 150, n17 = 150, n8 = 150; !(n3 == 155 && n15 == 155 && n12 == 155 && n5 <= 105 && n17 <= 105 && n8 >= 195); 
    n3 += 5, n15 += 5, n12 += 5, n5 -= 15, n17 -= 15, n8 += 15 ) {
    myservo.write(s3, n3);
   myservo.write(s15, n15);
  myservo.write(s12, n12);
   myservo.write(s5, n5);
   ...
   delay(20);  // Delay untuk memberikan waktu servos bergerak
    ...
    for (int n6 = 150, n18 = 150, n9 = 150; !(n6 == 135 && n18 == 135 && n9 == 135); n6 -= 5, n18 -= 5, n9 -= 5) {
    myservo.write(s6, n6);    // Menggerakkan servo 2
    myservo.write(s18, n18);  // Menggerakkan servo 14
    myservo.write(s9, n9);  // Menggerakkan servo 11
    delay(20);  // Delay untuk memberikan waktu servos bergerak
  ...
  for (int n5 = 120, n17 = 120, n8 = 180; !(n5 == 165 && n17 == 165 && n8 <= 135); n5 += 15, n17 += 15, n8 -= 15) {
   ...
   delay(20);  // Delay untuk memberikan waktu servos bergerak
    ...
    for (int n6 = 140, n18 = 140, n9 = 140; !(n6 == 155 && n18 == 155 && n9 == 155); n6 += 5, n18 += 5, n9 += 5) {
    myservo.write(s6, n6);    // Menggerakkan servo 2
    myservo.write(s18, n18);  // Menggerakkan servo 14
   myservo.write(s9, n9);  // Menggerakkan servo 11
    delay(20);  // Delay untuk memberikan waktu servos bergerak
