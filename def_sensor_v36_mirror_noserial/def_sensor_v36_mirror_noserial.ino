...
//  Serial.println("Hello");
  ...
  if (state == LOW && !isButtonPressed) {
    ...
    // ======= batas panggil fungsi rintangan ======== //
//    cek_arah_biasa_atas(10);
//    cek_arah_empty_serong_knn_mir(10);
//    cek_arah_tangga_mirror(10);
//    cek_arah_retak_korban(10);
//    cek_arah_lap_bawah(false, 10);
//    cek_arah_sempit(false, 10);
